...
\usepackage[hidelinks,
            ...
            pdfauthor={Burkay Ozdemir}]{hyperref}
\usepackage{cite}
...
\author{Burkay \"Ozdemir\inst{1}\orcidID{0009-0007-3701-0084}}

\authorrunning{B. \"Ozdemir}

\institute{Sakarya University, Department of Computer Engineering, Sakarya, Turkey\\
\email{mburkayozdemir@gmail.com}}
...
We prepare a PyTorch reference implementation with explicit
pitch-unit sigma, to be released upon acceptance.
...
a legacy mixed-protocol pair will be released upon acceptance.
...
input size. The full audit log, including the visualization that
prompted the $\sigma$ fix, will be released alongside the code upon
acceptance.
...
A release repository has been prepared at
\url{https://github.com/mburkay/image-xg-cnn-transformer} and will
be made public upon acceptance. It contains the source code, splits,
...
acceptance, with the DOI added to the repository README. Reviewers
who would like early access to the supplementary material before
acceptance may request it through the workshop submission system.
